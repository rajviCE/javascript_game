...
const aud2=new Audio("mixkit-instant-win-2021.wav");
const aud3=new Audio("mixkit-losing-drums-2023.wav");
const aud4=new Audio("success-fanfare-trumpets-6185.mp3");
        ...
        charArray.forEach((char, index) => {
          ...
          if (char === button.innerText) {
            ...
            if (winCount == charArray.length) {
              ...
              resultText.style.color='#ffb700d';
              resultText.innerHTML =`You Won <span>${name}</span> !!!`;
